...
Они сделаны таким образом, чтобы соответствовать разным требованиям, например переносимости между базами данных, стандартам GraphQL и т.д.
...
В резолвере нужно назначить декоратор
...
Чтобы защитить метод в резолвере, нужно назначить декоратор
